...
describe("exportPdf", () => {
  ...
  it("wraps text to the box width", async () => {
    ...
    // Empty paragraph keeps one (empty) line so spacing is preserved.
